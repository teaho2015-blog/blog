    ...
    public static class InnerBuilder implements Builder<BlogDTO> {
        ...
        public InnerBuilder parse(Blog blog) {
            id(blog.getId())
                    ...
                    .creator_name(blog.getCreator_name())
                    .create_time(blog.getCreate_time())
                    .updator_id(blog.getUpdator_id())
                    .updator_name(blog.getUpdator_name())
                    .update_time(blog.getUpdate_time())
                    .deletor_id(blog.getDeletor_id())
                    .deletor_name(blog.getDeletor_name())
                    .delete_time(blog.getDelete_time())
                    .delete_flag(blog.getDelete_flag())
                    .html_url("http://blog.teaho.net/article/"+blog.getId())
                    .attachedElderId_url("http://blog.teaho.net/api/v1/blog/article/"+blog.getId()+"/attachElderId");
            return this;
        }
