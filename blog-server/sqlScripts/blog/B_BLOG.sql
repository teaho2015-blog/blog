...
ALTER TABLE `blog`.`b_blog`
ADD COLUMN `TYPE` tinyint NULL DEFAULT 1 COMMENT '1，博文；2，外连文章' AFTER `CONTENT`,
ADD COLUMN `EXTERNAL_URL` varchar(255) NULL COMMENT '外连文章url' AFTER `TYPE`;