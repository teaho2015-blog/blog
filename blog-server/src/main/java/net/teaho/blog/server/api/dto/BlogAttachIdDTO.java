...
public class BlogAttachIdDTO {
    ...
    public static class InnerBuilder implements Builder<BlogAttachIdDTO> {
        ...
        public InnerBuilder parse(BlogVO blogVO) {
            id(blogVO.getId())
                    .image_url(blogVO.getImageUrl())
                    .date(blogVO.getDate() == null ? null : (Date) blogVO.getDate().clone())
                    .content(blogVO.getContent())
                    .title(blogVO.getTitle())
                    .title_secondary(blogVO.getTitleSecondary())
                    .creator_id(blogVO.getCreatorId())
                    .creator_name(blogVO.getCreatorName())
                    .create_time(blogVO.getCreateTime())
                    .updator_id(blogVO.getUpdatorId())
                    .updator_name(blogVO.getUpdatorName())
                    .update_time(blogVO.getUpdateTime())
                    .deletor_id(blogVO.getDeletorId())
                    .deletor_name(blogVO.getDeletorName())
                    .delete_time(blogVO.getDeleteTime())
                    .delete_flag(blogVO.getDeleteFlag())
