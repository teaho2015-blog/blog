...
<head>
    ...
    <link href="<%-- ${pageContext.request.contextPath} --%>https://blog.cdn.teaho.net/static/styles/blog/blog-home.css" rel="stylesheet">
    ...
    <!-- progress bar -->
    <link href='<%-- ${pageContext.request.contextPath} --%>https://blog.cdn.teaho.net/static/library/nprogress/nprogress.css' rel='stylesheet' type='text/css'>
...
<header class="intro-header" style="background-image: url('<%-- ${pageContext.request.contextPath} --%>https://blog.cdn.teaho.net/static/images/blog/blog-home-bg.jpg'); position : relative;">
    <div class="mask"></div>
    <div class="container">
...
<script src="<%-- ${pageContext.request.contextPath} --%>https://blog.cdn.teaho.net/static/library/bootstrap/dist/js/bootstrap.min.js"></script>

<!-- Theme JavaScript -->
<script src="<%-- ${pageContext.request.contextPath} --%>https://blog.cdn.teaho.net/static/scripts/blog/blog-theme.min.js"></script>

<script type="text/javascript" src="<%-- ${pageContext.request.contextPath} --%>https://blog.cdn.teaho.net/static/library/jquery/jquery.easing.1.3.js"></script>
<!-- https://github.com/keenwon/jqPaginator -->
<script type="text/javascript" src="<%-- ${pageContext.request.contextPath} --%>https://blog.cdn.teaho.net/static/library/jqPaginator/jqPaginator.min.js"></script>
...
<!-- nprogress -->
<script type="text/javascript" src="<%-- ${pageContext.request.contextPath} --%>https://blog.cdn.teaho.net/static/library/nprogress/nprogress.js"></script>

<script type="text/javascript" src="<%-- ${pageContext.request.contextPath} --%>https://blog.cdn.teaho.net/static/scripts/blog/blog-home.js"></script>
